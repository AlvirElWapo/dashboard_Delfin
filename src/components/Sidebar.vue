...
>>>>>>> f65b1b912f965828352d785963ffc22287b41f62
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'busqueda_moderador' ? activeClass : inactiveClass]"
          to="/busqueda_moderador"
        >
<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
  </svg>

            <span class="mx-4">Buscar Moderador</span>
        </router-link>

<<<<<<< HEAD
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'SEDES' ? activeClass : inactiveClass]"
          to="/busq_por_sede"
        >
<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
...
<<<<<<< HEAD
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'pase_de_lista' ? activeClass : inactiveClass]"
          to="/pase_de_lista"
        >
<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
    <path d="M6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm-1.391 7.361.707-3.535a3 3 0 0 1 .82-1.533L7.929 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h4.259a2.975 2.975 0 0 1-.15-1.639ZM8.05 17.95a1 1 0 0 1-.981-1.2l.708-3.536a1 1 0 0 1 .274-.511l6.363-6.364a3.007 3.007 0 0 1 4.243 0 3.007 3.007 0 0 1 0 4.243l-6.365 6.363a1 1 0 0 1-.511.274l-3.536.708a1.07 1.07 0 0 1-.195.023Z"/>
            ...
            <span class="mx-4">Pase de Lista Ponencia</span>
=======
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
...
>>>>>>> f65b1b912f965828352d785963ffc22287b41f62
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'pase_de_lista_moderador' ? activeClass : inactiveClass]"
          to="/pase_de_lista_moderador"
        >
<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
    <path d="M6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm-1.391 7.361.707-3.535a3 3 0 0 1 .82-1.533L7.929 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h4.259a2.975 2.975 0 0 1-.15-1.639ZM8.05 17.95a1 1 0 0 1-.981-1.2l.708-3.536a1 1 0 0 1 .274-.511l6.363-6.364a3.007 3.007 0 0 1 4.243 0 3.007 3.007 0 0 1 0 4.243l-6.365 6.363a1 1 0 0 1-.511.274l-3.536.708a1.07 1.07 0 0 1-.195.023Z"/>
  </svg>
...
=======
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Consultar Conferencias</span>
        </router-link>
>>>>>>> f65b1b912f965828352d785963ffc22287b41f62
...
<router-link
  class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
  :class="[$route.name === 'cronometro' ? activeClass : inactiveClass]"
  to="/cronometro"
>
...
<router-link
  class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
  :class="[$route.name === 'agregar_moderador' ? activeClass : inactiveClass]"
  to="/agregar_moderador"
>
<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
